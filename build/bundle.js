...
var _templatesEntryJsx = require('../templates/entry.jsx');

var _templatesEntryJsx2 = _interopRequireDefault(_templatesEntryJsx);
...
// Render
var Entry = _react2['default'].createFactory(_templatesEntryJsx2['default']);

_react2['default'].render(new Entry(props), document.getElementById('contents'));

},{"../templates/entry.jsx":158,"react":156}],158:[function(require,module,exports){
'use strict';
...
var DefaultTemplate = _react2['default'].createClass({
